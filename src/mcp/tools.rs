...
mod tests {
    ...
    fn source_validation_accepts_known_sources_and_rejects_unknown_sources() {
        ...
        assert!(error.message.contains(
            "aaro, cia, nara, govinfo, pursue, doj_epstein, doj_foia, frus, dtic, dia, noaa, nsa, state, fbi_vault"
        ));
    }
