...
pub(crate) fn canonicalize_official_url(url: &str, base_url: &str) -> String {
    ...
    if url_host_name.eq_ignore_ascii_case("www.foia.army.mil")
        && base_host.eq_ignore_ascii_case("foia.army.mil")
    {
        return url.replacen("://www.foia.army.mil", "://foia.army.mil", 1);
    }
    if url_host_name.eq_ignore_ascii_case("foia.army.mil")
        && base_host.eq_ignore_ascii_case("foia.army.mil")
...
pub(crate) fn is_allowed_army_url(url: &str, base_url: &str) -> bool {
